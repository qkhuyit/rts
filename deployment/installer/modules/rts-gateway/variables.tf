...
variable "configuration_content" {
  ...
  default = <<EOF
    ...
    redeem_url = "http://rts-keycloak:8080/realms/rts/protocol/openid-connect/token"
    validate_url = "http://rts-keycloak:8080/realms/rts/protocol/openid-connect/userinfo"
    oidc_jwks_url = "http://rts-keycloak:8080/realms/rts/protocol/openid-connect/certs"
