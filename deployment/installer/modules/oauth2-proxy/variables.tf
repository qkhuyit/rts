...
redeem_url = "http://keycloak.rts-auth:8080/realms/rts/protocol/openid-connect/token"
validate_url = "http://keycloak.rts-auth:8080/realms/rts/protocol/openid-connect/userinfo"
oidc_jwks_url = "http://keycloak.rts-auth:8080/realms/rts/protocol/openid-connect/certs"
